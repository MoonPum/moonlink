...
export class Config implements ConfigArgs {
  private constructor(
    ...
    readonly feeRecipient: web3.PublicKey,
    readonly operator: web3.PublicKey,
    readonly bump: number,
    readonly tradeFeeBasisPoints: number,
    readonly pendingAdmin: web3.PublicKey,
    readonly pumpFee: beet.bignum,
  ...
  pretty() {
    return {
      ...
      bump: this.bump,
      tradeFeeBasisPoints: this.tradeFeeBasisPoints,
      pendingAdmin: this.pendingAdmin.toBase58(),
      pumpFee: (() => {
        const x = <{ toNumber: () => number }>this.pumpFee
...
>(
  [
    ...
    ['bump', beet.u8],
    ['tradeFeeBasisPoints', beet.u16],
    ['pendingAdmin', beetSolana.publicKey],
    ['pumpFee', beet.u64],
    ['padding', beet.bytes],
  ],
  Config.fromArgs,
