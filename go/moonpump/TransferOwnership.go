...
func (inst *TransferOwnership) SetAdminAccount(admin ag_solanago.PublicKey) *TransferOwnership {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(admin).WRITE().SIGNER()
	return inst
}

// GetAdminAccount gets the "admin" account.
func (inst *TransferOwnership) GetAdminAccount() *ag_solanago.AccountMeta {
...
func NewTransferOwnershipInstruction(
	...
	config ag_solanago.PublicKey) *TransferOwnership {
